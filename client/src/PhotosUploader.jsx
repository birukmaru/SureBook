...
export default function PhotosUploader({
  ...
  async function addPhotoByLink(ev) {
    ...
    try {
      // POST request to upload the photo using the provided link
  ...
  return (
    <>
      {/* Input for adding photos via a link */}
      ...
      {/* Display uploaded photos and handle removal and selection of main photo */}
